...
public class CheckProject extends BaseEntity {
     ...
     * 委托单位地址
     */
    private String requesterUnitAddress;
     ...
     * 单位基本情况
     */
    private String unitBasicSituation;
    /**
     * 建筑基本情况
     */
    private String buildingBasicSituation;
    ...
    private Integer checkProjectStatus;//1、执行中  2、待签章 3、已签章  4、重新检测
     ...
     * 编写人
     */
    private Long compilingUserId;
    private String compilingUserName;
    ...
    private String riskProblemIds;//高危问题ids 以；号分隔
    private String score;//项目评分
    private String assessLevel;//安全评分等
    ...
    public String getRiskProblemIds() {
        return riskProblemIds;
    }

    public void setRiskProblemIds(String riskProblemIds) {
        this.riskProblemIds = riskProblemIds;
    }
    ...
    public String getConstructionUnit() {
        return StringUtils.isEmpty(constructionUnit) ? "" : constructionUnit;
    }
    ...
    public String getFireApproval() {
        return StringUtils.isEmpty(fireApproval) ? "" : fireApproval;
    }
    ...
    public void setSignInRequest(String signInRequest) {
        this.signInRequest = signInRequest;
    }

    public String getRequesterUnitAddress() {
        return requesterUnitAddress;
    }

    public void setRequesterUnitAddress(String requesterUnitAddress) {
        this.requesterUnitAddress = requesterUnitAddress;
    }
    ...
    public String getAssessmentRange() {
        return assessmentRange;
    }

    public void setAssessmentRange(String assessmentRange) {
        this.assessmentRange = assessmentRange;
    }

    public String getAssessmentExplanation() {
        return StringUtils.isEmpty(assessmentExplanation) ? "" : assessmentExplanation;
    }
    ...
    public String getUnitBasicSituation() {
        return unitBasicSituation;
    }

    public void setUnitBasicSituation(String unitBasicSituation) {
        this.unitBasicSituation = unitBasicSituation;
    }

    public String getBuildingBasicSituation() {
        return StringUtils.isEmpty(buildingBasicSituation) ? "" : buildingBasicSituation;
    }

    public void setBuildingBasicSituation(String buildingBasicSituation) {
        this.buildingBasicSituation = buildingBasicSituation;
    }
    ...
    public Long getCompilingUserId() {
        return compilingUserId;
    }

    public void setCompilingUserId(Long compilingUserId) {
        this.compilingUserId = compilingUserId;
    }

    public String getCompilingUserName() {
        return compilingUserName;
    }

    public void setCompilingUserName(String compilingUserName) {
        this.compilingUserName = compilingUserName;
    }
}
