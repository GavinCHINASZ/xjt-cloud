 ...
 * @date 2021/01/20
 **/
public class FireEyeEventHandle extends BaseEntity {
    /**
     * 设备id
     */
    ...
    public FireEyeEventHandle(){

    }

    public FireEyeEventHandle(Long projectId, Long deviceId, Long deviceFaultTypeId, Long fireEyeDeviceId, Long eventId, Integer deviceType,
        ...
        this.setFireEyeDeviceId(fireEyeDeviceId);
    ...
    public Long[] getFireEyeDeviceIds() {
        return fireEyeDeviceIds;
    }

    public void setFireEyeDeviceIds(Long[] fireEyeDeviceIds) {
        this.fireEyeDeviceIds = fireEyeDeviceIds;
    }
