 ...
 **/
public class VesaEventHandle extends BaseEntity {
    /**
     * 设备id
     */
    ...
    public VesaEventHandle(){

    }
    public VesaEventHandle(Long projectId, Long deviceId, Long deviceFaultTypeId, Long vesaDeviceId, Long eventId, Integer deviceType,
        ...
        this.setVesaDeviceId(vesaDeviceId);
    ...
    public Long[] getVesaDeviceIds() {
        return vesaDeviceIds;
    }

    public void setVesaDeviceIds(Long[] vesaDeviceIds) {
        this.vesaDeviceIds = vesaDeviceIds;
    }
