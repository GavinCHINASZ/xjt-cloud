...
public class ElectricalFireEventRecord extends BaseEntity {
    ...
    public ElectricalFireEventRecord() {
    }

    public ElectricalFireEventRecord(ElectricalFireDevice device) {
        this.setAlarmDeviceId(device.getId());
        this.setProjectId(device.getProjectId());
        this.setDeviceId(device.getDeviceId());
        this.setDeviceName(device.getDeviceName());
        this.setLeakageAlarmValue(device.getLeakageCurrValue());
        this.setTempAlarmValue(device.getTempValue());
        this.setSensorNo(device.getSensorNo());
    }
