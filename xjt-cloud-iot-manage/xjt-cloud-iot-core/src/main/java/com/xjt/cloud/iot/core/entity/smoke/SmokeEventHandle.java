 ...
 **/
public class SmokeEventHandle extends BaseEntity {
    /**
     * 设备id
     */
    ...
    public SmokeEventHandle(){

    }
    public SmokeEventHandle(Long projectId, Long deviceId, Long deviceFaultTypeId, Long smokeDeviceId, Long eventId, Integer deviceType,
        ...
        this.setSmokeDeviceId(smokeDeviceId);
    ...
    public Long[] getSmokeDeviceIds() {
        return smokeDeviceIds;
    }

    public void setSmokeDeviceIds(Long[] smokeDeviceIds) {
        this.smokeDeviceIds = smokeDeviceIds;
    }
