...
/**
 * @ClassName AirSamplingEvent
 * @Description 空气采样设备事件管理
 * @Author wangzhiwen
 * @Date 2021/3/31 9:07
 **/
public class AirSamplingEvent extends BaseEntity {
    ...
    private Integer deviationValue;     //偏差值 * 100
    ...
    private Integer eventType;//'事件类型　1 管道1值超高　　2 管道1值超低　　3 管道2值超高 4 管道2值超低'
