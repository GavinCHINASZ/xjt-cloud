...
public class SmokeEventController extends AbstractController{
    ...
    public String receive(HttpServletRequest request, String msg, String signature, String nonce){
        Data data = smokeEventService.receive(request, msg, nonce, signature);
        /*if (data != null){
        }*/
        return "ok";
    }
     ...
     * @return com.xjt.cloud.commons.utils.Data
     */
    @RequestMapping(value = "findSmokeEventReportCount/{projectId}")
    public Data findSmokeEventReportCount(String json){
        return smokeEventService.findSmokeEventReportCount(json);
    }
     ...
     * @return: com.xjt.cloud.commons.utils.Data
     */
    @RequestMapping(value = "downSmokeEventList/{projectId}")
    public void downSmokeEventList(String json, HttpServletResponse response){
        smokeEventService.downSmokeEventList(json, response);
    }
}
