...
public interface HCNetSDK extends StdCallLibrary {
    ...
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(HCNetSDKPath.DLL_PATH + "lib" + File.separator + "HCNetSDK.dll",
            HCNetSDK.class);
    /***宏定义***/
    //常量
...
//2007-04-16增加查询结果带卡号的文件查找
 ...
 NativeLong  NET_DVR_PlayBackByName(NativeLong lUserID, String sPlayBackFileName, W32API.HWND hWnd);
 NativeLong  NET_DVR_PlayBackByTime(NativeLong lUserID, NativeLong lChannel, NET_DVR_TIME lpStartTime, NET_DVR_TIME lpStopTime, W32API.HWND hWnd);
...
{
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary(HCNetSDKPath.DLL_PATH + "lib" + File.separator + "HCNetSDK.dll",
            PlayCtrl.class);
