...
public class VoiceUtils {
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
    	String  str = numberToChinese("192.168.1.65_1");
        SingleCallByTtsResponse singleCallByTtsResponse = singleCallByTts("13026690015","TTS_164681765","{\"code1\":\""+str+"\",\"code2\":\"05月09日18:28:22\",\"code3\":\"深圳中洲大厦\",\"code4\":\"火焰警报\"}");
