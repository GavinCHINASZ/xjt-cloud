package huawei.iotplatform.Subscription.test;
...
public class SubscriptionTest {
    ...
    private static void subDeviceManagementData(SubscriptionManagement subscriptionManagement, String notifyType, String callbackUrl, String accessToken) {
