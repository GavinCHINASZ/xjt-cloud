...
public class Pkcs {
     ...
     * @return Certificate
     */
    private static Certificate generateCertificateV3(String issuerStr, String subjectStr, KeyPair keyPair, Map<String, byte[]> result, String certificateCRL,
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ca.jks
        FileOutputStream outPutStream = new FileOutputStream(url + "keystore.p12");
        outPutStream.write(result.get("keyStoreData"));
        outPutStream.close();
        FileOutputStream fos = new FileOutputStream(new File(url + "keystore.cer"));
