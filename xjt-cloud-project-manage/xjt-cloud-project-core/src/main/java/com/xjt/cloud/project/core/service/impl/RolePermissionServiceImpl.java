...
import com.xjt.cloud.project.core.dao.project.RolePermissionDao;
import com.xjt.cloud.project.core.entity.Permission;
import com.xjt.cloud.project.core.entity.Role;
import com.xjt.cloud.project.core.entity.RolePermission;
import com.xjt.cloud.project.core.service.service.PermissionService;
import com.xjt.cloud.project.core.service.service.RolePermissionService;
...
public class RolePermissionServiceImpl extends AbstractService implements RolePermissionService {
    ...
    public Data addProjectAdminRolePermission(Role role) {
        ...
        for (Permission projectPermission : permissions) {
            if(!"photo_graph_manage_edit".equals(projectPermission.getSign())){//管理员不要禁用拍照权限
     ...
     **/
    @Override
    public Data addProjectOrdinaryRolePermission(Role ordinaryRole) {
