...
public interface BuildingDao {
     ...
     **/
    Long findByProjectAcreage(@Param("projectId")Long projectId);
    ...
    /**@MethodName: findByBuildingDeviceCount 查询建筑物设备数量
     * @Description:
     * @Param: [id]
     * @Return: int
     * @Author: zhangZaiFa
     ...
     **/
    int findByBuildingDeviceCount(@Param("buildingId")Long buildingId);
