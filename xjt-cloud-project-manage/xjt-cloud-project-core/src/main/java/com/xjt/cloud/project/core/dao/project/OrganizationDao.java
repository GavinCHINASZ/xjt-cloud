...
public interface OrganizationDao {
     ...
     *@Description 根据id查询层次序
     */
    String findOrgLayerOrderById(Long id);
    /**
     *@Author: dwt
     *@Date: 2020-07-24 10:09
     *@Param: Organization
     *@Return: Integer
     *@Description 保存公司或者部门层次序
     */
    Integer saveOrgLayerOrderById(Organization o);

    List<Organization> findAllOrgLayerOrder(Organization o);
}
