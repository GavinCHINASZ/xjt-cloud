...
import com.xjt.cloud.project.core.dao.project.BuildingFloorDao;
...
public class BuildingFloorServiceImpl extends AbstractService implements BuildingFloorService {
     ...
     */
    @Override
    public Data modifyBuildingFloor(String json){
        BuildingFloor buildingFloor = JSONObject.parseObject(json, BuildingFloor.class);
        buildingFloorDao.updateBuildingFloor(buildingFloor);
        return Data.isSuccess();
    }
