package com.xjt.cloud.maintenance.core.common;
...
public interface ConstantsProjectMsg {
    ...
    String MAINTENANCE_QR_CODE_WORD_FILE_URL = PropertyUtils.getProperty("maintenance.qr.code.word.file.url");// 报表中的二维码文件路径
    ...
    // 签到距离
    Integer SIGN_DISTANCE = PropertyUtils.getPropertyInteger("sign.distance") == null ? 1000 : PropertyUtils.getPropertyInteger("sign.distance");
}
