package com.xjt.cloud.maintenance.core.service.impl.fault;

import com.alibaba.fastjson.JSONObject;
import com.xjt.cloud.cas.client.adapters.SecurityUserHolder;
import com.xjt.cloud.commons.abstracts.AbstractService;
import com.xjt.cloud.commons.utils.*;
import com.xjt.cloud.maintenance.core.dao.fault.FaultHandlerDao;
import com.xjt.cloud.maintenance.core.dao.fault.FaultRepairRecordDao;
import com.xjt.cloud.maintenance.core.dao.fault.RepairProgressDao;
import com.xjt.cloud.maintenance.core.entity.fault.FaultHandler;
import com.xjt.cloud.maintenance.core.entity.fault.FaultRepairRecord;
...
//        String orgUserName = getOrgUserName(userId, faultRepairRecord.getProjectId());
        ...
        if (num > 0){
            ...
            repairProgress.setContent(userName + " 提交了维修订单");
            repairProgress.setCreateUserId(userId);
            repairProgress.setCreateUserName(userName);

            repairProgress.setRepairProgress(faultRepairRecord);
...
//        String orgUserName = getOrgUserName(userId, faultRepairRecord.getProjectId());
        if (faultRepairRecord.getRepairUserId() != null){
            ...
            repairProgress.setContent(userName + " 转派维修订单");
            repairProgress.setCreateUserId(userId);
            repairProgress.setCreateUserName(userName);
            repairProgress.setRepairProgress(faultRepairRecord);
            repairProgressDao.saverRepairProgress(repairProgress);
            ...
            if (faultRepairRecord.getWorkOrderStatus() != null) {
                ...
                if (faultRepairRecord.getWorkOrderStatus() == 4){
                    ...
                    repairProgress.setContent(userName + " 完成维修订单");
                }else if (faultRepairRecord.getWorkOrderStatus() == 6){
                    repairProgress.setTitle("暂停故障报修");
                    repairProgress.setContent(userName + " 暂停维修订单");
                }
                repairProgress.setCreateUserId(userId);
                repairProgress.setCreateUserName(userName);
                repairProgress.setRepairProgress(faultRepairRecord);
            ...
            if(StringUtils.isNotEmpty(faultRepairRecord.getMaintenanceResult())){
                ...
                repairProgress.setContent(userName + " 修改维修说明");
                repairProgress.setCreateUserId(userId);
                repairProgress.setCreateUserName(userName);
                repairProgress.setRepairProgress(faultRepairRecord);
                repairProgressDao.saverRepairProgress(repairProgress);
