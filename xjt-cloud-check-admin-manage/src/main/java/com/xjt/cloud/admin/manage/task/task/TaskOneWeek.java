...
/**
 * @ClassName TaskOneWeek
 * @Author dwt
 * @Date 2019-08-06 9:54
 * @Description 每周周期任务处理
 * @Version 1.0
 */
@Configuration
@Component
public class TaskOneWeek implements Job, Serializable {
    ...
    public void execute(JobExecutionContext jobExecutionContext) {
        ...
        try {
            //类型  7:每周  （每天凌晨一点：0 0 1 * * ?）
            String res = HttpUtils.sendGet(ConstantsClient.PERIOD_TASK_HANDLE_URL, "json={\"type\":7}");
