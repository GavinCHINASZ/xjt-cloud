...
/**
 * @ClassName TaskTwoYears
 * @Author dwt
 * @Date 2019-08-05 17:12
 * @Description 每两年周期任务处理
 * @Version 1.0
 */
@Configuration
@Component
public class TaskTwoYears implements Job, Serializable {
    private static Logger logger = LoggerFactory.getLogger(TaskTwoYears.class);
    @Override
    public void execute(JobExecutionContext jobExecutionContext){
        ...
        try {
            //0：每两年 （每月1日：0 0 0 1 * ?）
            String res = HttpUtils.sendGet(ConstantsClient.PERIOD_TASK_HANDLE_URL,"json={\"type\":0}");
