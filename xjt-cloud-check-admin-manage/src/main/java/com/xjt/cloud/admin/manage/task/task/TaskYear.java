 ...
 * @Description： 每年周期任务处理
 * @Version 1.0
 */
@Configuration
@Component
public class TaskYear implements Job, Serializable {

    private static Logger logger = LoggerFactory.getLogger(TaskYear.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext){
        ...
        try {
            //类型  1:每年 （每月1日：0 0 0 1 * ?）
            String res = HttpUtils.sendGet(ConstantsClient.PERIOD_TASK_HANDLE_URL,"json={\"type\":1}");
