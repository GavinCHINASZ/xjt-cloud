...
<head>
    <title>用户活跃报表</title>
    <!-- 页面相关JS -->
    <script type="text/javascript" src="/resource/views/pv/userActiveReportList.js"></script>
    <meta charset="utf-8">
    <!-- 引入 echarts.js -->
...
<div id="common_search" class="easyui-panel" fit="true">
    <!-- 用户活跃统计 -->
    <table id="uv_count_table" style="height: auto" fit="true"/>
    ...
    <div class="echart-wrap" style="display: flex;justify-content: space-between">
        <div id="main" style="width: 600px;height:360px;"/>
        <div id="mainPie" style="width: 600px;height:360px;"/>
    </div>
</div>
<!-- 主页面 end -->
