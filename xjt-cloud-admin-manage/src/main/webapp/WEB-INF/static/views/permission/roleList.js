...
function relationRoleTableInit(){
    ...
    $('#relation_permissionIds_table').datagrid({
        ...
        columns:[[
            ...
            {field:'menuSign',title:'菜单别名',width:100},
            {field:'permissionName',title:'权限名称',width:100},
            {field:'sign',title:'权限别名',width:100},
            {field:'perType',title:'平台类型',width:100,formatter:function (value) {
                    if (value == 1){
                        return "后台管理";
                    } else if(value == 2){
                        return "项目";
            ...
            {field:'permissionType',title:'权限类型',width:100,formatter:function (value) {
                    if (value == 1){
                        return "模块";
                    } else if(value == 2){
                        return "菜单";
